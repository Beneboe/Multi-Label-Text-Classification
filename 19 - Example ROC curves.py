...
fpr['bad'], tpr['bad'], _ = roc_curve(good_expect, (good_predict - 0.5) ** 2 + 0.5)
...
# plt.plot(fpr['bad'], tpr['bad'], color='purple', lw=lw, label='Example classifier', clip_on=False, zorder = 1000)
